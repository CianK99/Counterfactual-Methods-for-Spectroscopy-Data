...
def parse_arguments(standalone=False):
    ...
    parser.add_argument('--dataset', type=str, default='Coffee',
                        help='Dataset name or "custom" when using --custom_npz / --ucr_*')
    ...
    parser.add_argument("--custom_npz", type=str, default=None,
                        help="Path to a NPZ file with X_train/y_train/X_test/y_test")
    parser.add_argument("--ucr_train", type=str, default=None,
                        help="Path to UCR-style TRAIN.tsv")
    parser.add_argument("--ucr_test", type=str, default=None,
                        help="Path to UCR-style TEST.tsv")
    ...
    # ---- Global CF Configuration ----
    parser.add_argument('--mode', type=str, help='Counterfactual mode [local|global]', default='local', choices=['local', 'global'])

    parser.add_argument('--global_target', type=int, help='Target class for global CFs (None = auto flip)', default=None)

    parser.add_argument('--global_batch', type=int, help='Batch size to learn global mask', default=128)

    parser.add_argument('--global_epochs', type=int, help='Number of optimisation steps for global mask', default=800)
